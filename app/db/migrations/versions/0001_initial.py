...
Revision ID: 0001
Revises: 
Create Date: 2025-06-28 07:17:30.755772
...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('TRAFFIC', 'DEVICES', 'BOTH', 'UNLIMITED', name='plantype'), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.Column('traffic_limit', sa.Integer(), nullable=True),
    sa.Column('device_limit', sa.Integer(), nullable=True),
    sa.Column('availability', sa.Enum('ALL', 'NEW', 'EXISTING', 'INVITED', 'ALLOWED', name='planavailability'), nullable=False),
    ...
    op.create_table('plan_durations',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    sa.Column('type', sa.Enum('DURATION', 'TRAFFIC', 'SUBSCRIPTION', 'PERSONAL_DISCOUNT', 'PURCHASE_DISCOUNT', name='promocodetype'), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text("timezone('UTC', now())"), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text("timezone('UTC', now())"), nullable=False),
    sa.ForeignKeyConstraint(['activated_by'], ['users.telegram_id'], ),
    sa.PrimaryKeyConstraint('id'),
